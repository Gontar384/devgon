...
export function ProcessTimeline({ items }: ProcessTimelineProps) {
  ...
  return (
    <div ref={ref} className="relative">
      <div
        aria-hidden="true"
        className="lg:hidden absolute left-9 top-0 bottom-0 w-0.5 bg-muted-foreground/20"
      >
        <motion.div
      ...
      <ol className="hidden lg:flex flex-col gap-30 list-none p-0 m-0">
                ...
                {rowItems.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        aria-hidden="true"
                        className="z-10 absolute -top-12 left-1/2 -translate-x-1/2 text-5xl font-bold text-secondary/60"
                      >
                        {globalIndex + 1}
                      </div>
                      <div
